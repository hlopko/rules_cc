...
def configure_windows_toolchain(repository_ctx):
    ...
    paths = resolve_labels(repository_ctx, [
        "//cc/configure:BUILD.windows.tpl",
        "//cc/configure:windows_cc_toolchain_config.bzl",
        "//cc/configure:armeabi_cc_toolchain_config.bzl",
        "//cc/configure:vc_installation_error.bat.tpl",
        "//cc/configure:msys_gcc_installation_error.bat",
    ])

    repository_ctx.symlink(
        paths["//cc/configure:windows_cc_toolchain_config.bzl"],
        "windows_cc_toolchain_config.bzl",
    )
    repository_ctx.symlink(
        paths["//cc/configure:armeabi_cc_toolchain_config.bzl"],
        "armeabi_cc_toolchain_config.bzl",
    )
    repository_ctx.symlink(
        paths["//cc/configure:msys_gcc_installation_error.bat"],
    ...
    if not vc_path:
        repository_ctx.template(
            ...
            paths["//cc/configure:vc_installation_error.bat.tpl"],
            {"%{vc_error_message}": ""},
        )
    else:
    ...
    if not vc_path or missing_tools:
        repository_ctx.template(
            "BUILD",
            paths["//cc/configure:BUILD.windows.tpl"],
            {
