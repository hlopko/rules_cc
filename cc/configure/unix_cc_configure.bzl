...
def configure_unix_toolchain(repository_ctx, cpu_value, overriden_tools):
    ...
    paths = resolve_labels(repository_ctx, [
        "//cc/configure:BUILD.tpl",
        "//cc/configure:armeabi_cc_toolchain_config.bzl",
        "//cc/configure:unix_cc_toolchain_config.bzl",
        "//cc/configure:linux_cc_wrapper.sh.tpl",
        "//cc/configure:osx_cc_wrapper.sh.tpl",
    ])

    repository_ctx.symlink(
        paths["//cc/configure:unix_cc_toolchain_config.bzl"],
    ...
    cc_wrapper_src = (
        "//cc/configure:osx_cc_wrapper.sh.tpl" if darwin else "//cc/configure:linux_cc_wrapper.sh.tpl"
    )
